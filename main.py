...
col3.write(f"**Update:** {latest['Datetime'].strftime('%Y/%m/%d %H:%M')}")
...
ax1_2.axhline(70, color='red', alpha=0.5); ax1_2.axhline(30, color='green', alpha=0.5)
st.pyplot(fig1)
...
st.caption("私の回答にはハルシネーションが含まれている可能性があるため、公式の最新情報を常に疑い、確認してください。")
